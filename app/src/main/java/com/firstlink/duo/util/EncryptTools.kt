...
object EncryptTools {
    ...
    fun aesEncrypt(msg: String, key: String):String {
        ...
        sr.setSeed(key.toByteArray("utf-8"))
        kg.init(128, sr)
        ...
        return Base64.encodeToString(cipher.doFinal(msg.toByteArray("utf-8")), Base64.DEFAULT)
    }
    ...
    fun aesDecrypt(msg: String, key: String): String{
        ...
        val temp = Base64.decode(msg.toByteArray("utf-8"), Base64.DEFAULT)
